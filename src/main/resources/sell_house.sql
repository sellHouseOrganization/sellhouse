...
CREATE TABLE `areaprice` (
  ...
  `price` double(20) DEFAULT NULL COMMENT '单价',
...
CREATE TABLE `changehouse` (
  ...
  `paysum` double(20) DEFAULT NULL COMMENT '已付金额',
...
CREATE TABLE `offersum` (
  ...
  `sum` double(20) DEFAULT NULL COMMENT '金额',
...
CREATE TABLE `schedule` (
  ...
  `fromtMoney` double(20) DEFAULT NULL COMMENT '定金',
  `adviserid` int(11) DEFAULT NULL COMMENT '置业顾问ID',
  `remake` varchar(50) DEFAULT NULL COMMENT '简要备注',
  `scheduleDate` date DEFAULT NULL COMMENT '预定日期',
  `clientid` int(11) DEFAULT NULL COMMENT '客户ID',
  `mustPrices` double (50) DEFAULT NULL COMMENT '应交售价',
  `sumPrices` double(50) DEFAULT NULL COMMENT '成交总价',
